...
UPDATE TURNOVER_ROW
SET SIMILARITY_CHECKSUM = UPPER(MD5(AMOUNT_VALUE_CENTS || COALESCE(RECIPIENT, 'null') || DESCRIPTION));
...
ALTER TABLE TURNOVER_ROW
    ADD CONSTRAINT CO_SIMILARITY_CHECKSUM_IS_ON_SIMILAR_DATA
        CHECK ( SIMILARITY_CHECKSUM = UPPER(MD5(AMOUNT_VALUE_CENTS || COALESCE(RECIPIENT, 'null') || DESCRIPTION)));
