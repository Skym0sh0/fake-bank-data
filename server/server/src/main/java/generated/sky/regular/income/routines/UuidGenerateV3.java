...
public class UuidGenerateV3 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 346822257;

    /**
     * The parameter <code>REGULAR_INCOME.uuid_generate_v3.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>REGULAR_INCOME.uuid_generate_v3.namespace</code>.
     */
    ...
    /**
     * The parameter <code>REGULAR_INCOME.uuid_generate_v3.name</code>.
     */
    ...
    public UuidGenerateV3() {
        super("uuid_generate_v3", RegularIncome.REGULAR_INCOME, org.jooq.impl.SQLDataType.UUID);
