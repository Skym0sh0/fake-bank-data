...
public class CategoryRecord extends UpdatableRecordImpl<CategoryRecord> implements Record6<UUID, UUID, String, Boolean, String, OffsetDateTime> {

    private static final long serialVersionUID = -1535036124;
     ...
     */
    @Override
    public Row6<UUID, UUID, String, Boolean, String, OffsetDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row6<UUID, UUID, String, Boolean, String, OffsetDateTime> valuesRow() {
     ...
     */
    @Override
    public CategoryRecord values(UUID value1, UUID value2, String value3, Boolean value4, String value5, OffsetDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CategoryRecord(UUID id, UUID parentCategory, String name, Boolean isIncome, String description, OffsetDateTime lastUpdatedAt) {
        super(Category.CATEGORY);
