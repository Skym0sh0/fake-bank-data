...
public class TurnoverFileImportRecord extends UpdatableRecordImpl<TurnoverFileImportRecord> implements Record7<UUID, OffsetDateTime, String, Long, String, byte[], String> {

    private static final long serialVersionUID = -518494236;
    ...
    /**
     * Setter for <code>REGULAR_INCOME.turnover_file_import.file_content_type</code>.
     */
    ...
    /**
     * Getter for <code>REGULAR_INCOME.turnover_file_import.file_content_type</code>.
     */
     ...
     */
    @Override
    public Row7<UUID, OffsetDateTime, String, Long, String, byte[], String> fieldsRow() {
     ...
     */
    @Override
    public Row7<UUID, OffsetDateTime, String, Long, String, byte[], String> valuesRow() {
     ...
     */
    @Override
    public TurnoverFileImportRecord values(UUID value1, OffsetDateTime value2, String value3, Long value4, String value5, byte[] value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TurnoverFileImportRecord(UUID id, OffsetDateTime importedAt, String filename, Long fileSize, String fileContentType, byte[] fileContent, String checksum) {
        super(TurnoverFileImport.TURNOVER_FILE_IMPORT);
