...
public class UuidNsDns extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 885182203;

    /**
     * The parameter <code>REGULAR_INCOME.uuid_ns_dns.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNsDns() {
        super("uuid_ns_dns", RegularIncome.REGULAR_INCOME, org.jooq.impl.SQLDataType.UUID);
