...
public class FinancialTransactionRecord extends UpdatableRecordImpl<FinancialTransactionRecord> implements Record7<UUID, UUID, LocalDate, Integer, Boolean, String, String> {

    private static final long serialVersionUID = 1063257738;
     ...
     */
    @Override
    public Row7<UUID, UUID, LocalDate, Integer, Boolean, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row7<UUID, UUID, LocalDate, Integer, Boolean, String, String> valuesRow() {
     ...
     */
    @Override
    public FinancialTransactionRecord values(UUID value1, UUID value2, LocalDate value3, Integer value4, Boolean value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FinancialTransactionRecord(UUID id, UUID bankStatementId, LocalDate dateRecord, Integer amountValueCents, Boolean isPeriodic, String reason, String checksum) {
        super(FinancialTransaction.FINANCIAL_TRANSACTION);
