...
public class BankStatementRecord extends UpdatableRecordImpl<BankStatementRecord> implements Record3<UUID, Date, Integer> {

    private static final long serialVersionUID = -940694159;
     ...
     */
    public BankStatementRecord setDateRecord(Date value) {
        set(1, value);
        return this;
    }
     ...
     */
    @Override
    public Row3<UUID, Date, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row3<UUID, Date, Integer> valuesRow() {
     ...
     */
    @Override
    public BankStatementRecord value2(Date value) {
        setDateRecord(value);
        return this;
    }
     ...
     */
    @Override
    public BankStatementRecord values(UUID value1, Date value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public BankStatementRecord(UUID id, Date dateRecord, Integer amountBalanceCents) {
        super(BankStatement.BANK_STATEMENT);
