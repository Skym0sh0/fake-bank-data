...
public class UuidNsUrl extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -1085334277;

    /**
     * The parameter <code>REGULAR_INCOME.uuid_ns_url.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNsUrl() {
        super("uuid_ns_url", RegularIncome.REGULAR_INCOME, org.jooq.impl.SQLDataType.UUID);
