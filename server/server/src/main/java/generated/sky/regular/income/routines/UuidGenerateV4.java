...
public class UuidGenerateV4 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 598368297;

    /**
     * The parameter <code>REGULAR_INCOME.uuid_generate_v4.RETURN_VALUE</code>.
     */
    ...
    public UuidGenerateV4() {
        super("uuid_generate_v4", RegularIncome.REGULAR_INCOME, org.jooq.impl.SQLDataType.UUID);
