...
public class UuidGenerateV5 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = -448217991;

    /**
     * The parameter <code>REGULAR_INCOME.uuid_generate_v5.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>REGULAR_INCOME.uuid_generate_v5.namespace</code>.
     */
    ...
    /**
     * The parameter <code>REGULAR_INCOME.uuid_generate_v5.name</code>.
     */
    ...
    public UuidGenerateV5() {
        super("uuid_generate_v5", RegularIncome.REGULAR_INCOME, org.jooq.impl.SQLDataType.UUID);
