...
public class UuidNsX500 extends AbstractRoutine<UUID> {
    ...
    private static final long serialVersionUID = 1042155497;

    /**
     * The parameter <code>REGULAR_INCOME.uuid_ns_x500.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNsX500() {
        super("uuid_ns_x500", RegularIncome.REGULAR_INCOME, org.jooq.impl.SQLDataType.UUID);
