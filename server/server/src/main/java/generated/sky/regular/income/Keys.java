...
public class Keys {
    ...
    public static final UniqueKey<TurnoverRowRecord> TURNOVER_ROW_ID_KEY = Internal.createUniqueKey(TurnoverRow.TURNOVER_ROW, DSL.name("turnover_row_id_key"), new TableField[] { TurnoverRow.TURNOVER_ROW.ID }, true);
